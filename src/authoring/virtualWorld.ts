...
/**
 * Neutral authored-world biome ids. Keep this union in sync with `BiomeId`
 * without importing `core/types.ts`; `core` imports this file for Ctx contracts.
 */
export type VirtualBiomeId =
  | 'earthen'
  | 'frozen'
  | 'flooded'
  | 'timber'
