          ...
          if (door.seqDone !== true) {
            ...
            if (cursor >= chain.length) {
              ...
              if (edges[cursor]) {
                ...
                if (cursor >= chain.length) door.seqDone = true;
              ...
              door.seq = cursor; // derived, for HUD/probes
            }
          }
