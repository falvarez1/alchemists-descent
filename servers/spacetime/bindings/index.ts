...
const tablesSchema = __schema({
  ...
  player: __table({
    name: 'player',
    indexes: [
      { accessor: 'connectionId', name: 'player_connection_id_idx_btree', algorithm: 'btree', columns: [
        'connectionId',
      ] },
    ...
    constraints: [
      { name: 'player_connection_id_key', constraint: 'unique', columns: ['connectionId'] },
    ],
  }, PlayerRow),
  presence: __table({
    name: 'presence',
    indexes: [
      ...
      { accessor: 'room', name: 'presence_room_idx_btree', algorithm: 'btree', columns: [
        'room',
      ] },
    ],
    constraints: [
  ...
  session: __table({
    name: 'session',
    indexes: [
      { accessor: 'name', name: 'session_name_idx_btree', algorithm: 'btree', columns: [
        'name',
      ] },
    ],
    constraints: [
